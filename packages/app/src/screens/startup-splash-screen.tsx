...
const DAEDAL_MARK_URI = Asset.fromModule(require("../../assets/brand/daedal-mark-light.png")).uri;
...
const WEB_SPLASH_SHIMMER_KEYFRAME_ID = "daedal-splash-shimmer-keyframes";
const WEB_SPLASH_SHIMMER_ANIMATION_NAME = "daedal-splash-shimmer";
...
function WebLogoShimmer({ color }: { color: string }) {
  ...
  const shimmerStyle = useMemo(
    () => ({
      width: LOGO_SIZE,
      height: LOGO_SIZE,
      WebkitMaskImage: `url("${DAEDAL_MARK_URI}")`,
