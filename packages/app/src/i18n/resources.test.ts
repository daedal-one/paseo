...
describe("translation resources", () => {
  ...
  it("includes Settings expansion keys for the Batch 3B migration", () => {
    ...
    expect(en.settings.host.orchestration.enableTools.title).toBe("Enable Daedal DSH tools");
  ...
  it("includes workspace and panel keys for the Batch 4A migration", () => {
    ...
    expect(en.openProject.tiles.importSession.description).toBe(
      "Continue an existing DeepSeek Harness conversation",
    );
  });
  ...
  it("includes onboarding and direct connection keys for the Batch 4E migration", () => {
    expect(en.onboarding.title).toBe("Welcome to Daedal DSH");
  ...
  it("includes remaining small utility chrome keys for the Batch 4O migration", () => {
    ...
    expect(en.desktop.quitting.title).toBe("Quitting Daedal DSH...");
  ...
  it("includes desktop update utility keys for the Batch 4Q migration", () => {
    ...
    expect(en.desktop.rosetta.runningIntel).toBe(
      "You're running the Intel build of Daedal DSH under Rosetta on Apple Silicon.",
    );
  ...
  it("includes desktop permission utility keys for the Batch 4R migration", () => {
    ...
    expect(en.desktop.permissions.testNotification.title).toBe("Daedal DSH notification test");
  ...
  it("includes desktop daemon settings keys for the Batch 4S migration", () => {
    ...
    expect(en.desktop.integrations.cli.installFailed).toBe("Unable to install the Daedal DSH CLI.");
  });
