...
export const ar: TranslationResources = {
  ...
  agentStream: {
    ...
    permission: {
      submitFailed: "تعذّر تأكيد إجابتك. تم الاحتفاظ بخياراتك. تحقّق من الاتصال وحاول مجددًا.",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "الأرشيف غير متاح هنا لأنه لم يتم إنشاء مساحة العمل هذه كشجرة عمل Daedal DSH",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "اسمح لـ Daedal DSH ببدء تشغيل البرنامج الخفي المدمج وإيقافه",
        ...
        pausedStopFailed:
          "تم إيقاف إدارة البرنامج الخفي المضمنة مؤقتًا، لكن لم يتمكن Daedal DSH من إيقاف البرنامج الخفي.",
        updateFailed: "غير قادر على تحديث إدارة البرنامج الخفي المضمنة.",
      },
      keepRunning: {
        title: "استمر في تشغيل البرنامج الخفي بعد الإقلاع عن التدخين",
        hint: "يستمر تشغيل Daemon عند إنهاء Daedal DSH",
      },
      logs: {
        title: "ملف السجل",
    ...
    rosetta: {
      ...
      runningIntel: "أنت تقوم بتشغيل إصدار Intel من Daedal DSH ضمن Rosetta على Apple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "اختبار الإخطار Daedal DSH",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "غير قادر على تثبيت Daedal DSHCLI.",
      },
    },
  },
  rootError: {
    title: "واجه Daedal DSH مشكلة.",
  ...
  pairing: {
    ...
    direct: {
      title: "اتصال مباشر",
      helper: "أدخل عنوان خادم Daedal DSH.",
      fields: {
        host: "Host",
        port: "ميناء",
    ...
    remoteSsh: {
      title: "SSH عن بُعد",
      helper: "الاتصال بخادم Daedal DSH يعمل على المضيف البعيد.",
      fields: {
        target: "مضيف SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "اقرأ كيفية عمل تتابع Daedal DSH",
      ...
      updateRequired: "حدّث المضيف لتمكين التتابع من Daedal DSH Desktop.",
      unavailable: "عرض الاقتران غير متاح.",
      hint: "قم بمسح رمز QR هذا باستخدام Daedal DSH على هاتفك، أو انسخ الرابط أدناه.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "استدعى Daedal DSH {{count}} مرة",
      other: "استدعى Daedal DSH {{count}} مرات",
    },
    and: "و",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "سلّم Daedal DSH الإشعار إلى نظام التشغيل.",
    ...
    metadataGeneration: {
      ...
      description:
        "اختر النموذج الذي يستخدمه Daedal DSH لعناوين مساحات العمل وأسماء الفروع ورسائل الالتزام ومسودات طلبات السحب",
      selection: "اختيار النموذج",
      automatic: "تلقائي",
      preferred: "يدوي",
      automaticHint: "يختار Daedal DSH نموذجًا سريعًا متاحًا",
      preferredHint: "اختر النموذج الذي يستخدمه Daedal DSH",
      model: "النموذج",
      fallbackHint: "إذا لم يكن متاحًا، يستخدم Daedal DSH نموذجًا آخر متاحًا",
      docs: "الوثائق",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "تتشارك علامات تبويب المتصفح تسجيلات الدخول وبيانات المواقع عبر Daedal DSH.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "يؤدي هذا إلى تحديث Daedal DSH على هذا الكمبيوتر",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "تحديث مهارات Daedal DSH ؟",
        updateFallback: "مزامنة المهارات المجمعة لجهازك.",
        uninstallTitle: "إلغاء تثبيت مهارات Daedal DSH ؟",
        uninstallMessage: "يزيل جميع مهارات تنسيق Daedal DSH من ~/.agents ، ~/.claude ، ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "تمكين أدوات Daedal DSH",
          hint: "سيتمكن الوكلاء من إدارة أشجار العمل والوكلاء والجداول الزمنية",
          accessibilityLabel: "حقن أدوات Daedal DSH",
        },
        systemPrompt: {
          title: "موجه النظام",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "هذا المضيف غير متصل.  يقوم Daedal DSH بإعادة الاتصال تلقائيًا - انتظر حتى يتم الاتصال بالإنترنت مرة أخرى قبل إعادة التشغيل.",
          requestFailedTitle: "خطأ",
          requestFailedMessage:
            "فشل في إرسال طلب إعادة التشغيل.  يقوم Daedal DSH بإعادة الاتصال تلقائيًا - حاول مرة أخرى بمجرد ظهور المضيف على أنه متصل بالإنترنت.",
          dialogFailedMessage: "غير قادر على فتح مربع حوار تأكيد إعادة التشغيل.",
        },
        update: {
          desktopManagedHint:
            "يدير Daedal DSH Desktop هذا البرنامج الخفي. حدّث Daedal DSH Desktop على المضيف.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "يشرف Daedal DSH على العملية ويعين منفذًا عبر $PASEO_PORT",
        actions: {
      ...
      metadata: {
        ...
        info: "تعليمات خاصة بالمشروع يتم إدخالها في الذكاء الاصطناعي الذي يستخدمه Daedal DSH لإنشاء بيانات التعريف - استخدمها لفرض اصطلاحات فريقك مثل تسمية الفرع أو نمط الالتزام أو تنسيق PR",
