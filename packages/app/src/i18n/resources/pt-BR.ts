...
export const ptBR: TranslationResources = {
  ...
  agentStream: {
    ...
    permission: {
      submitFailed:
        "Não foi possível confirmar sua resposta. Suas escolhas foram mantidas. Verifique a conexão e tente novamente.",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Arquivar não está disponível aqui porque este workspace não foi criado como um worktree do Daedal DSH",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Permitir que o Daedal DSH inicie e pare o daemon integrado",
        ...
        registrationFailed:
          "O daemon integrado foi iniciado, mas o Daedal DSH não conseguiu salvar a conexão localhost. Desative e reative o gerenciamento do daemon ou adicione localhost manualmente.",
        pausedStopFailed:
          "O gerenciamento do daemon integrado foi pausado, mas o Daedal DSH não conseguiu parar o daemon.",
        updateFailed: "Não foi possível atualizar o gerenciamento do daemon integrado.",
      },
      keepRunning: {
        title: "Manter daemon em execução ao sair",
        hint: "O daemon continua em execução quando você sai do Daedal DSH",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel:
        "Você está executando a build Intel do Daedal DSH pelo Rosetta no Apple Silicon.",
    ...
    permissions: {
      ...
      testNotification: {
        title: "Teste de notificação do Daedal DSH",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Não foi possível instalar a CLI do Daedal DSH.",
      },
    },
  },
  rootError: {
    title: "O Daedal DSH encontrou um problema.",
  ...
  pairing: {
    ...
    direct: {
      title: "Conexão direta",
      helper: "Informe o endereço de um servidor Daedal DSH.",
      fields: {
        host: "Host",
        port: "Porta",
        password: "Senha",
    ...
    remoteSsh: {
      title: "SSH remoto",
      helper: "Conecte-se a um daemon Daedal DSH no host remoto.",
      fields: {
        target: "Host SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Leia como o relay do Daedal DSH funciona",
      ...
      updateRequired: "Atualize o host para ativar o relay pelo Daedal DSH Desktop.",
      unavailable: "Oferta de pareamento indisponível.",
      hint: "Escaneie este QR code com o Daedal DSH no seu celular ou copie o link abaixo.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "chamou o Daedal DSH {{count}} vez",
      other: "chamou o Daedal DSH {{count}} vezes",
    },
    and: "e",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "O Daedal DSH entregou a notificação ao sistema operacional.",
    ...
    metadataGeneration: {
      ...
      description:
        "Escolha o modelo usado pelo Daedal DSH para títulos de espaços de trabalho, nomes de branches, mensagens de commit e rascunhos de pull request",
      selection: "Seleção de modelo",
      automatic: "Automática",
      preferred: "Manual",
      automaticHint: "O Daedal DSH escolhe um modelo rápido disponível",
      preferredHint: "Escolha o modelo que o Daedal DSH usa",
      model: "Modelo",
      fallbackHint: "Se ele não estiver disponível, o Daedal DSH usa outro modelo disponível",
      docs: "Documentação",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "As abas do navegador compartilham logins e dados de sites no Daedal DSH.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Isso atualiza o Daedal DSH neste computador",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Atualizar Daedal DSH skills?",
        updateFallback: "Sincronize as skills incluídas com sua máquina.",
        uninstallTitle: "Desinstalar Daedal DSH skills?",
        uninstallMessage:
          "Remove todas as skills de orquestração do Daedal DSH de ~/.agents, ~/.claude e ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Ativar ferramentas do Daedal DSH",
          hint: "Agentes poderão gerenciar worktrees, agentes e agendamentos",
          accessibilityLabel: "Injetar ferramentas do Daedal DSH",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este host está offline. O Daedal DSH reconecta automaticamente. Aguarde ele voltar a ficar online antes de reiniciar.",
          requestFailedTitle: "Erro",
          requestFailedMessage:
            "Falha ao enviar a solicitação de reinício. O Daedal DSH reconecta automaticamente. Tente novamente quando o host aparecer como online.",
          dialogFailedMessage: "Não foi possível abrir o diálogo de confirmação de reinício.",
        },
        update: {
          desktopManagedHint:
            "Este daemon é gerenciado pelo Daedal DSH Desktop. Atualize o Daedal DSH Desktop no host.",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "O Daedal DSH supervisiona o processo e atribui uma porta via $PASEO_PORT",
        actions: {
      ...
      metadata: {
        title: "Geração de metadados",
        info: "Instruções específicas do projeto injetadas nos prompts de IA que o Daedal DSH usa para gerar metadados. Use-as para aplicar convenções da sua equipe, como nomes de branch, estilo de commit ou formato de PR",
