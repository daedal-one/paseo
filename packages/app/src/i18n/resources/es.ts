...
export const es: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "El archivo no está disponible aquí porque este espacio de trabajo no se creó como un árbol de trabajoDaedal DSH",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Deje queDaedal DSHinicie y detenga el demonio incorporado",
        ...
        pausedStopFailed:
          "La gestión del demonio integrado se pausó, peroDaedal DSHno pudo detener el demonio.",
      ...
      keepRunning: {
        ...
        hint: "Daemonsigue ejecutándose cuando sales deDaedal DSH",
      },
      logs: {
    ...
    updates: {
      status: {
        unavailable:
          "Las actualizaciones automáticas no están disponibles en esta compilación. Instala una nueva manualmente.",
    ...
    rosetta: {
      ...
      runningIntel: "Estás ejecutando la compilaciónInteldeDaedal DSHenRosettaenApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Prueba de notificaciónDaedal DSH",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "No se puede instalar elDaedal DSHCLI.",
      },
    },
  },
  rootError: {
    title: "Daedal DSH tuvo un problema.",
  ...
  pairing: {
    discovery: companionDiscovery.es,
    connectionMethods: {
    ...
    direct: {
      title: "Conexión directa",
      helper: "Ingrese la dirección de un servidorDaedal DSH.",
      fields: {
        host: "Host",
        port: "Puerto",
        password: "Contraseña",
    ...
    remoteSsh: {
      title: "SSH remoto",
      helper: "Conéctate a un daemon de Daedal DSH en el host remoto.",
      fields: {
        target: "Host SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Leer cómo funciona el relé de Daedal DSH",
      ...
      updateRequired: "Actualice el host para habilitar el relé desde Daedal DSH Desktop.",
      unavailable: "Oferta de maridaje no disponible.",
      hint: "Escanee este códigoQRconDaedal DSHen su teléfono o copie el enlace a continuación.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "llamó a Daedal DSH {{count}} vez",
      other: "llamó a Daedal DSH {{count}} veces",
    },
    and: "y",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Daedal DSH entregó la notificación al sistema operativo.",
    ...
    metadataGeneration: {
      ...
      description:
        "Elige el modelo que Daedal DSH usa para títulos de espacios de trabajo, nombres de ramas, mensajes de commit y borradores de pull requests",
      selection: "Selección de modelo",
      automatic: "Automática",
      preferred: "Manual",
      automaticHint: "Daedal DSH elige un modelo rápido disponible",
      preferredHint: "Elige el modelo que usa Daedal DSH",
      model: "Modelo",
      fallbackHint: "Si no está disponible, Daedal DSH usa otro modelo disponible",
      docs: "Documentación",
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Las pestañas del navegador comparten inicios de sesión y datos de sitios en Daedal DSH.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Esto actualizaDaedal DSHen esta computadora.",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "¿Actualizar las habilidades deDaedal DSH?",
        updateFallback: "Sincronice las habilidades incluidas con su máquina.",
        uninstallTitle: "¿Desinstalar las habilidadesDaedal DSH?",
        uninstallMessage:
          "Elimina todas las habilidades de orquestaciónDaedal DSHde ~/.agents, ~/.claude, ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Habilitar herramientasDaedal DSH",
          hint: "Los agentes podrán gestionar árboles de trabajo, agentes y horarios.",
          accessibilityLabel: "Inyectar herramientasDaedal DSH",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este anfitrión está desconectado.Daedal DSHse vuelve a conectar automáticamente; espere hasta que vuelva a estar en línea antes de reiniciar.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "No se pudo enviar la solicitud de reinicio.Daedal DSHse vuelve a conectar automáticamente; inténtelo nuevamente una vez que el host se muestre en línea.",
          dialogFailedMessage:
            "No se puede abrir el cuadro de diálogo de confirmación de reinicio.",
        },
        update: {
          desktopManagedHint:
            "Este daemon está administrado por Daedal DSH Desktop. Actualiza Daedal DSH Desktop en el host.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Daedal DSHsupervisa el proceso y asigna un puerto vía $PASEO_PORT",
        actions: {
          add: "Agregar guión",
          edit: "Editar",
          remove: "Eliminar",
      ...
      metadata: {
        title: "Generación de metadatos",
        info: "Instrucciones específicas del proyecto inyectadas en los mensajes de IA queDaedal DSHutiliza para generar metadatos; úselas para hacer cumplir las convenciones de su equipo, como la denominación de ramas, el estilo de confirmación o el formatoPR.",
