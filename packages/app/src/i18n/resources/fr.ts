...
export const fr: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "L'archive n'est pas disponible ici car cet espace de travail n'a pas été créé en tant qu'arbre de travailDaedal DSH",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "LaissezDaedal DSHdémarrer et arrêter le démon intégré",
        ...
        pausedStopFailed:
          "La gestion du démon intégré a été suspendue, maisDaedal DSHn'a ​​pas pu arrêter le démon.",
      ...
      keepRunning: {
        ...
        hint: "Daemoncontinue de fonctionner lorsque vous quittezDaedal DSH",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Vous exécutez la versionInteldeDaedal DSHsousRosettasurApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Test de notificationDaedal DSH",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Impossible d'installer leDaedal DSHCLI.",
      },
    },
  },
  rootError: {
    title: "Daedal DSH a rencontré un problème.",
  ...
  pairing: {
    ...
    direct: {
      title: "Connexion directe",
      helper: "Saisissez l'adresse d'un serveurDaedal DSH.",
      fields: {
        host: "Host",
        port: "Port",
    ...
    remoteSsh: {
      title: "SSH distant",
      helper: "Connectez-vous à un daemon Daedal DSH sur l’hôte distant.",
      fields: {
        target: "Hôte SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Lire comment fonctionne le relais Daedal DSH",
      ...
      updateRequired: "Mettez à jour l’hôte pour activer le relais depuis Daedal DSH Desktop.",
      unavailable: "Offre de jumelage indisponible.",
      hint: "Scannez ce codeQRavecDaedal DSHsur votre téléphone ou copiez le lien ci-dessous.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "a appelé Daedal DSH {{count}} fois",
      other: "a appelé Daedal DSH {{count}} fois",
    },
    and: "et",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Daedal DSH a transmis la notification au système d’exploitation.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choisissez le modèle utilisé par Daedal DSH pour les titres d’espaces de travail, les noms de branches, les messages de commit et les brouillons de pull request",
      selection: "Sélection du modèle",
      automatic: "Automatique",
      preferred: "Manuel",
      automaticHint: "Daedal DSH choisit un modèle rapide disponible",
      preferredHint: "Choisissez le modèle utilisé par Daedal DSH",
      model: "Modèle",
      fallbackHint: "S’il est indisponible, Daedal DSH utilise un autre modèle disponible",
      docs: "Documentation",
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Les onglets du navigateur partagent les connexions et les données des sites dans Daedal DSH.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Cela met à jourDaedal DSHsur cet ordinateur",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Mettre à jour les compétencesDaedal DSH?",
        updateFallback: "Synchronisez les compétences regroupées sur votre machine.",
        uninstallTitle: "Désinstaller les compétencesDaedal DSH?",
        uninstallMessage:
          "Supprime toutes les compétences d'orchestrationDaedal DSHde ~/.agents, ~/.claude, ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Activer les outilsDaedal DSH",
          hint: "Les agents pourront gérer les arbres de travail, les agents et les horaires",
          accessibilityLabel: "Injecter les outilsDaedal DSH",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Cet hôte est hors ligne.Daedal DSHse reconnecte automatiquement: attendez qu'il soit de nouveau en ligne avant de redémarrer.",
          requestFailedTitle: "Erreur",
          requestFailedMessage:
            "Échec de l'envoi de la demande de redémarrage.Daedal DSHse reconnecte automatiquement - réessayez une fois que l'hôte apparaît comme en ligne.",
          dialogFailedMessage:
            "Impossible d'ouvrir la boîte de dialogue de confirmation de redémarrage.",
        },
        update: {
          desktopManagedHint:
            "Ce daemon est géré par Daedal DSH Desktop. Mettez à jour Daedal DSH Desktop sur l’hôte.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Daedal DSHsupervise le processus et attribue un port via $PASEO_PORT",
        actions: {
      ...
      metadata: {
        title: "Génération de métadonnées",
        info: "Instructions spécifiques au projet injectées dans les invites de l'IA queDaedal DSHutilise pour générer des métadonnées: utilisez-les pour appliquer les conventions de votre équipe telles que la dénomination des branches, le style de validation ou le formatPR.",
